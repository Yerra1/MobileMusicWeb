...
function navigate(page){$$('.page').forEach(p=>p.classList.toggle('active',p.id===page));$$('.mobile-bottom button').forEach(b=>b.classList.toggle('selected',b.dataset.page===page));$$('.side-link').forEach(b=>b.classList.toggle('active',b.dataset.page===page));window.scrollTo({top:0,behavior:'smooth'})}
